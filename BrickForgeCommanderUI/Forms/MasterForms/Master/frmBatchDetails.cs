...
namespace BrickForgeCommanderUI.Forms.MasterForms.Master
{
    public partial class frmBatchDetails : Form
    {
        ...
        private readonly string tableName = "BatchDetails";
        ...
        {
            dgvBatchDetails.DefaultCellStyle.BackColor = Color.FromArgb(95, 95, 95);
            dgvBatchDetails.ColumnHeadersDefaultCellStyle.BackColor = Color.FromArgb(95, 95, 95);
        ...
        {
            SqlCommandHelper.DisplayData(tableName, dgvBatchDetails, dataTable);
        }
        ...
        {
            lblVendorTypeId.Text = dgvBatchDetails.SelectedCells[0].Value.ToString();
            MasterControlHelper.CellSingleClick(lblVendorTypeId, tableName, dgvBatchDetails, e);
        }

        private void dgvVendorTypeDetails_CellContentDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            MasterControlHelper.CellDoubleClick(lblVendorTypeId, txtVendorTypeName, tableName, dgvBatchDetails, e);
        }
